  ...
  return (
    ...
    <Disclosure
      ...
      className={classNames(
        scrollPosition > 0 ? "bg-white/70 backdrop-blur-2xl" : "bg-black/0",
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="block lg:hidden h-8 w-auto pr-1">
                    <Image
                      src={classNames(
                        scrollPosition > 0
                          ? "/images/theivy-black.png"
                          : "/images/theivy-white.png"
                      )}
                      alt="the ivy"
                      width={50}
                      height={50}
                  ...
                  {/* LARGE SCREEN */}
                  <div className="hidden lg:block h-32 w-auto pt-8 pr-5">
                    <Image
                      src={classNames(
                        scrollPosition > 0
                          ? "/images/theivy-black.png"
