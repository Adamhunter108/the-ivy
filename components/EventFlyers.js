      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="max-w-lg mx-auto grid gap-10 lg:grid-cols-2 lg:max-w-none pl-2 justify-center items-center justify-items-center place-items-center mt-3">
          <div>
            <div className="flex justify-center mb-6">
              ...
              >
                ...
                >
                  ...
                  <div className="pl-3">LB Cleanup Sip & Paint</div>
                </button>
              </a>
            </div>
            <div className="hover:scale-110 ease-in-out duration-200">
              <Image
                ...
                src="/images/flyer-display/5-23-24.jpg"
                height={450}
                width={450}
                alt="Flyer 1"
                blurDataURL="/images/flyer-display/5-23-24.jpg"
                placeholder="blur"
                loading="lazy"
              />
            </div>
          ...
          <div>
            <div className="flex justify-center mb-6">
              <a
                href="https://square.link/u/IrMIreNi"
                target="_blank"
                rel="noreferrer"
                className="flex flex-row"
              >
                ...
                >
                  ...
                  <div className="pl-3">Taylor Swift Craft Night</div>
                </button>
              </a>
            </div>
            ...
            <div className="hover:scale-110 ease-in-out duration-200">
              <Image
                ...
                data-aos-delay="300"
                className="max-w-full h-auto rounded-xl"
                src="/images/flyer-display/6-5-24.jpg"
                height={450}
                width={350}
                alt="Flyer 2"
                blurDataURL="/images/flyer-display/6-5-24.jpg"
                placeholder="blur"
                loading="lazy"
              />
            </div>
